...
//Downloads text at the top center 
	...
	public static By objDeleteDownloadCTA = By.xpath("//*[@id='tvDeleteDownload'] | //*[@text=' Delete Download ']");
	...
	public static By objDownloadVideoQualityPopup = By.xpath("//*[contains(text(),'Download Video Quality')] | //*[@id='popup_title']");
	public static By objDownloadQualityOptions(String Quality) {
		return By.xpath("//*[@id='radioButton_downlaodQuality' or @text='"+Quality+"'] | //*[contains(text(),'"+Quality+"')]");
	}

	public static By objStartDownloadCTA = By.xpath("//*[contains(text(),'Start Download')] | //*[@id='bottomSheetDialogStartDownloadBtn']");

	public static By objvideostab= By.xpath("//*[@text=' Videos '] | //*[@text='Videos' or @text='VIDEOS']");

	public static By objDownloadCompleteIcon = By.xpath("//*[@contentDescription='downloaded'] | //*[@id='img_state']/parent::*/parent::*[@id='rl_end']");

	public static By objPlayDownloadedContent = By.xpath("//*[contains(text(),'Play')] | //*[@id='tvPlay']");

	public static By objPauseIconOnPlayer = By.xpath("//*[@text='p'] | //*[@id='playerPlayPauseButton']");

	public static By objBackinPlayer = By.xpath("//*[@text='A'] | //*[@id='playerBackButton']");
	
	public static By objshowstab = By.xpath("//*[@text='Shows']");	
	public static By objmoviestab=By.xpath("//*[@text='Movies']");
	public static By objBrowseToDownloadBtn = By.xpath("//*[@text=' Browse to Download '] | //*[@id='btn_browse_to_download']");
	public static By objDownloadedContent = By.xpath("//*[@class='android.view.View' and ./*[@class='android.widget.ProgressBar'] and ./parent::*[@class='android.view.View']]//following-sibling::*[1] | //*[@contentDescription='downloaded'] | (//*[@id='tv_title'])[1]");
	public static By objDownloadedVideoContent = By.xpath("//*[@class='android.view.View' and ./*[@class='android.widget.ProgressBar'] and ./parent::*[@class='android.view.View']]//following-sibling::*[1] | //*[@resource-id='com.graymatrix.did:id/tv_title']");
	public static By objDownloadingCircularBar = By.xpath("//*[@class='android.widget.ProgressBar'] | //*[@class='android.widget.ImageView' and ./parent::*[@id='rl_circular']] | //*[@id='content_download_progress']");
	public static By objPauseDownloadoption = By.xpath("//*[@text=' Pause '] | //*[@resource-id='com.graymatrix.did:id/tvPauseAll']");
	public static By objCancelDownloadOption = By.xpath("//*[@text=' Cancel '] | //*[@id='tvCancelDownload']");
