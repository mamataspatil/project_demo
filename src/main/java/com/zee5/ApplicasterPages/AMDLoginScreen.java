...
public class AMDLoginScreen {
	...
	public static By objEnterPasswordField = By.xpath("//*[@id='txtET_password_input'] | //*[@id='heading' and @text='Enter Password']");
	...
	public static By objEmailSelect = By.xpath("//*[@id='sem_title_default']");
