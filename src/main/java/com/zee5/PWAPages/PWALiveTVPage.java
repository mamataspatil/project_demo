...
//	  	==================VINAY=================
	...
	public static By objLiveChannelCardTitle = By.xpath("(//h3[contains(@class, 'cardTitle')])[1]");
	
	public static By objAllChnnelName = By.xpath("(((((((//div[@class='trayContentWrap']//div[@class='trayHeader']//h2[.='All TV Channels']))//parent::*//parent::*)//child::*[2])//child::*//div[@class='slick-track'])//child::*//div[@class='clickWrapper']//figure//a[@class='noSelect content ']//img)[1])");
	
	public static By objLiveTVViewAll= By.xpath("//div[@class='trayHeader']//h2[.='All TV Channels']//following-sibling::*//*[@class = 'view-all']");
	 
	public static By objLiveTvFilterOption = By.xpath("//*[contains(@class,'noSelect filterCompButton noSelect activeFilter iconInitialLoad-ic_filter')]");
