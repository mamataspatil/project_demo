...
//	ONBOARDING
	...
	public static By objCleverTapPopUpAccept=By.xpath("//button[@id='wzrk-confirm']");
     // Clevertap Notification
	public static By objNotificationPopUp = By.xpath("//button[@id='wzrk-cancel']");
	
	public static By objsubscription = By.xpath("//*[@class='stepTitle']");
	
	public static By objLoginToZee5PageText = By.xpath("//*[contains(@class,'loginHeaderIn') and text()='Login to ZEE5']");
	public static By objLoginPassword = By.xpath("//input[@type='password']");
	public static By objLoginProceed = By.xpath("//*[@class='popupBtn' and text()='PROCEED']");
	public static By objForgotPasswordPage = By.xpath("//div[@class='formHeader' and text()='Forgot Password']");
	public static By objInvalidLoginError = By.xpath("//*[@class='error' and text()='The mobile number and password combination was wrong during login.']");
	public static By objForgotPasswordButton = By.xpath("//*[contains(@class,'redirectLink') and contains(text(),'Forgot Password')]");
	public static By objActiveHome = By.xpath("//a[text()='Home' and contains(@class,'active')]");

	public static By objWebLoginButton = By.xpath("//button[contains(@class, 'noSelect buttonGradient')][.='Login']");
	
	public static By objEnterPasswordField = By.xpath("//div[@class='verifyBtn enterPwdVmn']//button[@type='button']");
	
	public static By objEnterPasswordPopupField = By.xpath("//input[contains(@name, 'inputPassword')]");
	
	public static By objParentalPasswordField  = By.xpath("//input[@name='inputPassword']");
