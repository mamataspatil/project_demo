...
public class ZNAMixpanel_Journey {
	...
	public void verifyCarouselBannerClickEvent(String userType, String pTabName) throws Exception {
		System.out.println("Verify Carousel Banner Click Event");
		Zee5ApplicasterMixPanelBusinessLogic.relaunch(true);
		Zee5ApplicasterMixPanelBusinessLogic.verifyCarouselBannerClickEvent(userType, pTabName);
