...
public class TvZee5ATVMixpanelAdForcedExitEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void AdForcedExit_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.adForcedExitEvent("Free", "Home", "Free");
	}
