...
public class TvZee5ATVMixpanelAdWatchDuratioEvent {
...
//	@Test(priority = 1)
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void adDuration_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.adWatchDurationEvent("Free", "Home", "Free");
	}
