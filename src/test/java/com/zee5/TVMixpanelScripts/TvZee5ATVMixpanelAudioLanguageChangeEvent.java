...
public class TvZee5ATVMixpanelAudioLanguageChangeEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void audioLanguag_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.audioLanguageChnageEvent("Free", "Home", "Free");
	}
