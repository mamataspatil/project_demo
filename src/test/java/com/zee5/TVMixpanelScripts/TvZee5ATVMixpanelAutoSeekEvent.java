...
public class TvZee5ATVMixpanelAutoSeekEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void autoSeek_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.autoseekEvent(userType, userType, userType);
	}
