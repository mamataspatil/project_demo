...
public class TvZee5ATVMixpanelPauseEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void pauseEvent_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.pauseEvent(userType, userType, userType);
	}
