...
public class TvZee5ATVMixpanelPlayerCTAEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void playerCTA_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.playerCTAEvent(userType, userType, userType);
	}
