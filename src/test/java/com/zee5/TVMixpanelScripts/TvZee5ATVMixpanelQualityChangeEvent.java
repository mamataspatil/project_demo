...
public class TvZee5ATVMixpanelQualityChangeEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void qualityChange_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.qualityChnageEvent(userType, userType, userType);
	}
