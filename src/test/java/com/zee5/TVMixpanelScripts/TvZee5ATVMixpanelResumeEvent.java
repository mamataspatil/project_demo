...
public class TvZee5ATVMixpanelResumeEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void resume_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.resumeEvent(userType, userType, userType);
	}
