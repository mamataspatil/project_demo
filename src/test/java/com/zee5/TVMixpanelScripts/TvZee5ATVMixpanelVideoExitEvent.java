...
public class TvZee5ATVMixpanelVideoExitEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void videoExit_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.videoExitEvent(userType, userType, userType);
	}
