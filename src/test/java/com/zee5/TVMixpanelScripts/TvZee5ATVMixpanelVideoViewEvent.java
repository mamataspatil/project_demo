...
public class TvZee5ATVMixpanelVideoViewEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void videoView_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.videoViewEvent(userType, userType, userType);
	}
