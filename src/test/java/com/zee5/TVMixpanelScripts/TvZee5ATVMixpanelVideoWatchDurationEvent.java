...
public class TvZee5ATVMixpanelVideoWatchDurationEvent {
	...
	@Test(priority = 2)
	@Parameters({ "userType" })
	public void videowatchDuration_MP(String userType) throws Exception {
		Zee5TvMixPanelBusiness.videoWatchedDuration(userType, userType, userType);
	}
